...
models) to more generic models (regression or SARIMA).  One challenge in making
comparisons to mechanistically detailed models is that these models are often 
